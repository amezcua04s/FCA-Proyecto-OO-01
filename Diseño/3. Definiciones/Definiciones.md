...
|"Android.ListView"|Una vista ListView visualiza una lista deslizable verticalmente de varios elementos, donde cada elemento puede definirse como un Layout.|[Android ListView][ALVW]|
...
|"Android.Widget"|El paquete de widgets contiene elementos de interfaz de usuario (en su mayoría visuales) para usar en la pantalla de su aplicación, se usara para realizar el interfaz de usuarios.|[Android Widget][ANWG]|
